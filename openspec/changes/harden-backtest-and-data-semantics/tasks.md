...
- [ ] 1.2 Update the market-data-schema-and-adapter-boundary delta to make OHLCV quality rules, duplicate collapse, and volume handling explicit.
...
- [ ] 2.1 Keep the canonical owners limited to backtest, data_loader, metrics, storage, and report.
- [ ] 2.2 Preserve the change as a coordinated contract migration rather than a new execution simulator or data platform.
- [ ] 2.3 Record the public artifact schema risk for `trade_log.csv` and the downstream impact on research/report artifacts.
...
- [ ] 4.3 Tighten market-data validation and attach a data-quality summary through the storage-owned artifact path.
