# candidate-promotion-and-rejection-policy Specification

## Purpose
Define the canonical post-search decision policy that evaluates existing evidence and emits validated/rejected/inconclusive outcomes for validation and walk-forward workflows.
